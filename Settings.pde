...
final float BRANCHING_CHANCE = 2.f / 100.0f; // DEF: 0.02 (2%)
final float BRANCH_MOVEMENT = 0.2f; // DEF: 0.2
final int BRANCH_COUNT = 3; // DEF: 3
final float WIDTH_EXPANSION = 0.5f; // DEF: 1.0f;
final float WIDTH_MULTIPLIER = 1.0f; // DEF: 1.0f;
